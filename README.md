...
- **Empirical Rigor:** Backed by 976 automated tests across 81 test suites to catch routing, security, and cost-contract regressions.
...
| Automated Tests | **976 passing tests across 81 suites** |
...
# Run full test suite (81 test suites, 976 tests)
npm test
