...
Backed by **841 automated tests across 114 test suites** (100% green CI), REI.ai enforces verifiable cost savings, prompt-cache optimization, anti-slop verification, and client-side security.
...
- **Empirical Rigor:** Backed by 841 automated tests across 114 test suites with a fast local test loop (`npm run test:fast` / `jest --maxWorkers=50%`) on ThinkPad T14 Gen 2a.
...
| Automated Tests | **841 passing tests across 114 suites** |
...
# Run serial test suite (114 test suites, 841 tests)
npm test
