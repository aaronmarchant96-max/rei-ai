...
Backed by **1291 automated tests across 110 test suites** (100% green CI), REI.ai enforces verifiable cost savings, prompt-cache optimization, anti-slop verification, and client-side security.
...
- **Empirical Rigor:** Backed by 1291 automated tests across 110 test suites with a fast local test loop (`npm run test:fast` / `jest --maxWorkers=50%`) on ThinkPad T14 Gen 2a.
...
| Automated Tests | **1291 passing tests across 110 suites** |
...
# Run serial test suite (110 test suites, 1291 tests)
npm test
