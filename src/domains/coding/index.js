...
export default {
  ...
  fingerprint: {
    ...
    matchTerms: ["implement", "build", "debug", "fix", "refactor", "function", "component", "module", "api", "jest", "vite", "react", "node", "typescript", "javascript", "python", "test", "patch", "class", "hook", "route", "blueprint", "clean version", "source code", "login", "auth", "merge", "async", "await"],
    temperature: 0.3,
