...
import { T, STARTERS, HEAT } from "./modules/debate-furnace/config.js";
import { useMobile, titleCase, cleanQuestion, toBase64Url, fromBase64Url, makeSharePayload, buildShareLink, summarizeAiFailure, safelyReplaceUrl } from "./modules/debate-furnace/utils.js";
import { HISTORY_KEY, HISTORY_LIMIT, getSavedDebateHistory, summarizeDebate, persistDebateHistory, formatSavedAt } from "./modules/debate-furnace/history.js";
import { DECISION_PATH_KEY, getSavedDecisionPathPreference, shouldShowDecisionPath, getDecisionPath } from "./modules/debate-furnace/decisionPath.js";
import { shortLabel, verdictLabel, getQuestionTypeLabel, getHingeClarity, QUESTION_TYPE_LABELS } from "./modules/debate-furnace/classifier.js";

import { Pill } from "./modules/debate-furnace/components.jsx";
import OpeningScreen from "./modules/debate-furnace/OpeningScreen.jsx";
import RoundScreen from "./modules/debate-furnace/RoundScreen.jsx";
import AnalysisScreen from "./modules/debate-furnace/AnalysisScreen.jsx";
import FinalReport from "./modules/debate-furnace/FinalReport.jsx";
  ...
  if (!debate)
    return (
      <OpeningScreen
        ...
        loadSavedDebate={loadSavedDebate}
...
{analysis ? (
          ...
          <FinalReport
            ...
            decisionPathShown={decisionPathShown}
            decisionPathPreference={decisionPathPreference}
            setDecisionPathPreference={setDecisionPathPreference}
            open={open}
            setOpen={setOpen}
            copyRound={copyRound}
            roundCopied={roundCopied}
