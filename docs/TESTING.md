...
REI.ai currently has 79 test suites with 967 tests passing. The generated count is recorded in `src/data/claims.json`. This document explains the testing philosophy, what each category covers, and how to write new tests.
...
Latest verified full-suite result (2026-08-20): **79/79 suites**, **967/967 tests**.
