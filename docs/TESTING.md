...
REI.ai currently has 108 test suites with 1270 tests passing. The generated count is recorded in `src/data/claims.json`. This document explains the testing philosophy, what each category covers, and how to write new tests.
...
Latest verified full-suite result (2026-08-24): **108/108 suites**, **1270/1270 tests**.
