/**
 * @file shared/lib/toolParser.js
 * Schema-validated tool call and thinking-tag extraction engine.
 ...
 */
export function extractThinkingAndContent(text) {
 ...
 */
export function validateToolArguments(toolName, rawArgs) {
